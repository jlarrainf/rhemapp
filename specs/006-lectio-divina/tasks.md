...
- [ ] T1 — Confirmar la guía doctrinal fija y la política de publicación pública automática.
  - RF: RF-3, RF-6, RF-7
...
- [ ] T2 — Diseñar el prompt versionado con ejemplos positivos/negativos, instrucciones anti-inyección y schema de salida.
...
- [ ] T3 — Diseñar extracción de anclajes y validadores de especificidad/diversidad.
  - RF: RF-4, RF-5, RF-10
...
- [ ] T4 — Definir límites de costo, timeout, generación única y métricas.
...
- [ ] T9 — Publicar automáticamente solo las adaptaciones que superen todos los validadores.
...
- [ ] T10 — Implementar logs técnicos y métricas sin contenido privado innecesario.
  - RF: RF-10
...
- [ ] T11 — Crear sección colapsable cerrada por defecto.
  - RF: RF-1, RF-2, RF-6
  - Hecho cuando: teclado, foco y lector de pantalla funcionan.
- [ ] T12 — Mostrar preguntas, carga, fallback y errores en español.
  - RF: RF-4, RF-5, RF-9
