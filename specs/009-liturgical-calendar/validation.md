...
```bash
npm run test:readings       # 49 pruebas aprobadas
npm run test:calendar       # 12 pruebas aprobadas
...
2. Activar un enlace disponible, por ejemplo el 12 de septiembre: debe abrir `/daily?date=2026-09-12`.
3. En Daily, comprobar “Contexto litúrgico”, “Fuente y verificación” y el enlace de vuelta al calendario.
4. Usar “Siguiente” para abrir `month=2026-10` y recorrer los controles con `Tab`.
5. Comprobar el API: `/api/calendar?month=2026-09` responde 200; repetir `month` responde 400 con un error en español.
