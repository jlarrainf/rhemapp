...
`SPEC CUMPLIDA` — RF-1 a RF-15 validados; la ampliación de santos, la fuente secundaria y la captura diaria de nombres de Vatican News están implementadas con publicación segura, idempotente y evidencia automatizada/manual. La ejecución remota fue comprobada mediante el workflow de GitHub Actions y queda configurada para repetirse diariamente según su horario UTC.
